...
export default function Navbar() {
  ...
  return (
    <nav>
      ...
      <div className=" text-white font-semibold flex flex-row items-center justify-end space-x-4 py-2 bg-[#0D2048] w-full pr-10">
        <div className="flex items-start w-full pl-8 ">
          <Link href={"/"}>
            <img src={ICONS.logo} width={60} height={60} alt="logo.png" />
          </Link>
        </div>
        <ul className="flex list-none justify-between text-lg bg-[#0D2048] gap-6 sm:hidden hidden h-full lg:flex">
        <li className="flex flex-row justify-center items-center gap-2 hover:bg-gray-600 hover:rounded rounded-5 p-2 group">
          <svg
            width="21"
            height="21"
            viewBox="0 0 21 21"
          ...
          />
          <path d="M13.4583 16.3333H7.70834" stroke-width="2" stroke-linecap="round" />
        </svg>

          <Link href="#" className="relative group-hover:bg-transparent">
            Home
            <span className="group-hover:bg-transparent after:content-[''] after:absolute after:left-1/2 after:top-full after:h-[2px] after:w-0 after:bg-white after:transition-all after:duration-400 group-hover:after:left-0 group-hover:after:w-full"></span>
          </Link>
        </li>
          <li className="flex flex-row stroke-white justify-center items-center gap-2 hover:bg-gray-600 hover:rounded rounded-5 p-2 group">
            <svg
              width="15"
              height="20"
              viewBox="0 0 15 20"
        ...
        <div className="lg:flex hidden">
          ...
          <Link href="" onClick={handleSmallerScreemNavigation}>
                <button className="bg-blue-800 inline-flex rounded-full relative py-2 w-[130px] items-center justify-center lg:gap-4 sm:gap-4 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110">
                  <img
                    className="border-[1px] rounded-full border-white"
                    src={ICONS.person} 
                    alt="" />
              ...
              <Link href="" onClick={handleSmallerScreemNavigation}>
                <button className="border-2 border-blue-800 sm:p-2 inline-flex rounded-full relative py-2 w-[130px] items-center justify-center lg:gap-2 sm:gap-4 transition ease-in-out delay-150 bg-white hover:-translate-y-1 hover:scale-110">
                  <img
                    className="border-[1px] rounded-full border-blue-800"
                    src={ICONS.person}
                    alt=""
                  />
                  <option
         ...
         {/* Navbar Responsive  */}
        <div onClick={handleSmallerScreemNavigation} className="flex lg:hidden">
          {menuIcon ? (
            <Image
              src={ICONS.close}
              alt="close"
        ...
        <div
          className={
            menuIcon
              ? "lg:hidden absolute top-[73px] right-0 bottom-0 left-[-2] flex justify-center items-center w-full h-screem bg-MAIN_HIGH_BLUE text-center ease-in duration-300"
              : "lg:hidden absolute top-[73px] right-0 left-[-110%] flex justify-center items-center w-full h-screem bg-MAIN_HIGH_BLUE text-center ease-in duration-300"
          }
        >
          <div className="w-80">
            <ul className="font-bold text-2xl">
              <li
                ...
                className="flex list-none justify-center items-center gap-2 hover:bg-gray-600 hover:rounded rounded-5 p-5 group"
              >
                <Link href="/" className="relative group-hover:bg-transparent">
                  Home
                  <span className="group-hover:bg-transparent after:content-[''] after:absolute after:left-1/2 after:top-full after:h-[2px] after:w-0 after:bg-white after:transition-all after:duration-400 group-hover:after:left-0 group-hover:after:w-full"></span>
